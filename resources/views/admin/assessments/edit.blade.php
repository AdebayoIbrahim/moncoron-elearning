                                    ...
                                    <div id="options-container-{{ $questionIndex }}">
                                        @foreach ($question['options'] as $optionIndex => $option)
                                            <div class="form-group option-group">
                                                <label for="questions[{{ $questionIndex }}][options][{{ $optionIndex }}][text]">Option {{ $optionIndex + 1 }}</label>
                                                ...
                                                <input type="checkbox" name="questions[{{ $questionIndex }}][options][{{ $optionIndex }}][correct]" class="form-check-input" @if($option['correct']) checked @endif>
                                            </div>
                                        @endforeach
                                    </div>
