            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h2>
                        ...
                        <button type="button" class="btn btn-primary pull-right" id="addAssessment">
                        ...
                        <table class="table-bordered table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.courses.assessments.show', [$course->id, $assessment->id]) }}">
                                            {{ $assessment->name }}
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown text-center">
                                            ...
                                            <ul class="dropdown-menu text-small">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('admin.courses.assessments.show', [$course->id, $assessment->id]) }}">
                                                        <i class="fa fa-eye"></i> View
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item editAssessment" href="{{ route('admin.courses.assessments.edit', [$course->id, $assessment->id]) }}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('student.courses.assessments.attempt', [$course->id, $assessment->id]) }}">
                                                        <i class="fa fa-play"></i> Take Assessment
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
...
function addOption(event) {
    ...
    if (optionCount >= 5) return; // Limit to 5 options
    const alphabet = 'ABCDE';
