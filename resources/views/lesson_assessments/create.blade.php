    ...
    <div id="questions-container">
        <div class="question">
            ...
            <div class="form-group">
                ...
                <select name="questions[0][correct_option]" class="form-control correct_option" id="correct_option_0 " required>
                    @foreach(['A', 'B', 'C', 'D', 'E'] as $option)
            ...
            <div class="form-group">
                ...
                <input type="number" name="questions[0][value]" class="form-control question_value" id="value_0" required>
            </div>
